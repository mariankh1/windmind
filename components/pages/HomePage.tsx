import { 
  ...
  const HomePage = () => {
    ...
    if (isLoading) {
      return (
        <IonPage>
          <IonContent className="ion-padding flex items-center justify-center bg-rose-50">
            <div className="text-center">
              <div className="wine-glass-loader mx-auto mb-6">
                <div className="glass"></div>
                <div className="wine"></div>
              </div>
              <h2 className="text-2xl font-bold text-rose-900">Pouring Knowledge...</h2>
            </div>
          </IonContent>
        </IonPage>
      );
